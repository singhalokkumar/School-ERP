...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url();?>public/css/styles1.css" type="text/css" />
...
<div id="container">
	<div id="header">
            <img src="<?php echo base_url();?>public/images/logo.jpg" style="border-radius: 5px; border: #000 solid thin"></img>   
